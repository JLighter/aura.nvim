...
local base_group = lush(function()
	return {
		...
		StatusLine({ fg = foreground, bg = background.lighten(2), gui = styles.inverse }),
		StatusLineNC({ fg = foreground, bg = background.lighten(2), gui = styles.inverse }),
		...
		Boolean({ AuraGreen }),
		Float({ AuraGreen }),
		Identifier({ fg = AuraForeground.fg.hex, gui = styles.bold }),
		Function({ AuraOrangeBold }),
		Statement({ AuraRed }),
		Conditional({ AuraPurple }),
		Repeat({ AuraPurple }),
		Label({ AuraRed }),
		Exception({ AuraPurple }),
		Keyword({ AuraPurple }),
		Operator({ AuraPurple }),
		PreProc({ AuraPurple }),
		Include({ AuraPurple }),
		Define({ AuraPurple }),
		Macro({ AuraPurple }),
		PreCondit({ AuraPurple }),
		Type({ AuraBlue }),
		StorageClass({ AuraOrange }),
		Structure({ AuraPurple}),
		Typedef({ AuraPink }),
		SpecialChar({ AuraRed }),
		Tag({ AuraPurpleBold }),
		Delimiter({ AuraPurple }),
		Comment({ AuraRed }),
		Debug({ AuraRed }),
